...
MODEL_CARDS: tuple[ModelCard, ...] = (
    ModelCard(
        ...
        cite_key="Cur26",
        tool_note=(
            "agent-assisted editing in the Cursor IDE: formalizing Scott's 1964 "
            "*Measurement Structures and Linear Inequalities* in Lean 4 / mathlib, "
    ...
    ModelCard(
        ...
        tool_note=(
            ...
            "`Scott1964/MeasurementStructures/`, documentation, and medium proof obligations "
